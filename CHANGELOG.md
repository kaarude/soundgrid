...
BlackHole loopback hardware validation and Apple Developer ID signing remain release gates for a stable macOS build. Until signing credentials are configured, v0.2.0 macOS artifacts are published from hyphenated tags as explicit prerelease builds; stable tags fail closed.
